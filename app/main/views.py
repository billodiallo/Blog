...
def new_blog():
    ...
    if form.validate_on_submit():
        ...
        for email in subscriber:
            mail_message("New Blog Post from Billo's Blog ","email/postnotification",email.email,subscriber=subscriber)
...
def subscriber():
    ...
    if subscriber_form.validate_on_submit():
        ...
        mail_message("Hello, Welcome To Billo's Blog.","email/welcome_subscriber",subscriber.email,subscriber=subscriber)
